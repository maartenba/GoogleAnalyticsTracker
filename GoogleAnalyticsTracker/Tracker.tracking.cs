...
namespace GoogleAnalyticsTracker {
	public partial class Tracker : ITrackEvents, ITrackPageViews, ITrackTransactions, ITrackTransactionItems {
		public void TrackPageView(string pageTitle, string pageUrl, string hostname = null, string userAgent = null, string characterSet = null, string language = null) {
			...
			RequestUrlSync(UseSsl ? BeaconUrlSsl : BeaconUrl, parameters, userAgent);
		}

		public void TrackEvent(string category, string action, string label, int value, string hostname = null, string userAgent = null, string characterSet = null, string language = null) {
			Dictionary<string, string> parameters = new Dictionary<string, string>();
			parameters.Add("utmwv", AnalyticsVersion);
			parameters.Add("utmn", GenerateUtmn());
			parameters.Add("utmhn", hostname ?? Hostname);
		...
		public void TrackTransaction(string orderId, string storeName, string total, string tax, string shipping, string city, string region, string country, string hostname = null, string userAgent = null, string characterSet = null, string language = null) {
			Dictionary<string, string> parameters = new Dictionary<string, string>();
			parameters.Add("utmwv", AnalyticsVersion);
			parameters.Add("utmn", GenerateUtmn());
			parameters.Add("utmhn", hostname ?? Hostname);
		...
		public void TrackTransactionItem(string orderId, string productId, string productName, string productVariation, string productPrice, string quantity, string hostname = null, string userAgent = null, string characterSet = null, string language = null) {
			Dictionary<string, string> parameters = new Dictionary<string, string>();
			parameters.Add("utmwv", AnalyticsVersion);
			parameters.Add("utmn", GenerateUtmn());
			parameters.Add("utmhn", hostname ?? Hostname);
